...
songList_Dir = '/Users/jafetaparicio/OneDrive - Eastern Connecticut State University/College/Fall2020/Thesis/Lyrics/SongLists'
...
#        
#        with open(os.path.join(songListDir,  str(year)+'.txt'), 'a') as f:
#            f.write("\t".join(row))
#            f.close()
#            
